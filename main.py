...
from compare import print_comparison, print_curves, print_attention
...
def main():
    ...
    print_curves(t_history, g_history)
    print_attention(transformer, "C'est un jour merveilleux.", src_vocab, tgt_vocab)
